...
WSGI_APPLICATION = 'bookscope.wsgi.application'
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_PAGINATION_CLASS": "bookscope.api.StandardResultsSetPagination",
    ...
    "EXCEPTION_HANDLER": "bookscope.api.custom_exception_handler",
}
...
SPECTACULAR_SETTINGS = {
    "TITLE": "BookScope API",
    "DESCRIPTION": "Book discovery, bookshelf, recommendation, and reading analytics API.",
    "VERSION": "1.0.0",
